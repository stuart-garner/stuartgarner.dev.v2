...
const Article = (props: PropTypes) => {
  ...
  return (
    <div className="bg-light-article-background dark:bg-dark-article-background relative flex flex-col rounded-2xl p-0">
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        <PrismicNextImage
          ...
          className=" h mt-10 aspect-video rounded-t-xl object-cover lg:mt-0 lg:mb-0"
        />
      </motion.div>
      <div className=" relative flex flex-col rounded-2xl  p-10">
        ...
        >
          <div>
            ...
            <div className="py-5 text-light-default dark:text-dark-default">
